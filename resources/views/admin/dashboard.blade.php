<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        <div class="stat-card">
            ...
            <p class="stat-card-value">{{ number_format($stats['totalUsers']) }}</p>
        </div>
        <div class="stat-card">
            <p class="stat-card-label">Total Jobs</p>
            <p class="stat-card-value">{{ number_format($stats['totalJobs']) }}</p>
        </div>
        <div class="stat-card">
            <p class="stat-card-label">Active Jobs</p>
            <p class="stat-card-value text-emerald-400">{{ number_format($stats['activeJobs']) }}</p>
        </div>
        <div class="stat-card">
            <p class="stat-card-label">Runs (24h)</p>
            <p class="stat-card-value">{{ number_format($stats['runsLast24h']) }}</p>
        </div>
        <div class="stat-card">
            <p class="stat-card-label">Failures (24h)</p>
            <p class="stat-card-value text-red-400">{{ number_format($stats['failedRunsLast24h']) }}</p>
        </div>
    </div>
