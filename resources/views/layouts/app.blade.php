...
<body class="bg-midnight-950 text-midnight-50 min-h-screen">
    <div class="flex min-h-screen">
        ...
        <aside class="fixed inset-y-0 left-0 w-64 bg-midnight-900 border-r border-midnight-800 hidden lg:block">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    ...
                    <div class="pt-6 pb-2">
                        <p class="px-3 text-xs font-semibold text-midnight-500 uppercase tracking-wider">{{ __('app.settings') }}</p>
                    </div>
                    ...
                    <div class="pt-6 pb-2">
                        <p class="px-3 text-xs font-semibold text-midnight-500 uppercase tracking-wider">{{ __('app.admin') }}</p>
                    </div>
        ...
        <!-- Mobile Off-Canvas Menu (Hidden on desktop) -->
        <div id="dashboard-menu-overlay" class="fixed inset-0 bg-midnight-950/80 backdrop-blur-sm hidden lg:!hidden" style="z-index: 9998;" aria-hidden="true"></div>
        
        <aside 
            id="dashboard-mobile-menu"
            class="fixed top-0 h-full w-64 bg-midnight-900 border-r border-midnight-800 transition-transform duration-300 ease-in-out overflow-y-auto lg:!hidden"
        ...
        >
            <div class="flex flex-col h-full">
                ...
                <div class="flex items-center justify-between px-6 h-16 border-b border-midnight-800">
                    ...
                    <button id="dashboard-menu-close" class="p-2 text-midnight-400 hover:text-midnight-50 rounded-lg hover:bg-midnight-800 transition-colors" aria-label="Close menu">
        ...
        <div class="lg:hidden fixed top-0 left-0 right-0 h-16 bg-midnight-900 border-b border-midnight-800 z-50 px-4 flex items-center justify-between">
            ...
            <button id="mobile-menu-btn" class="p-2 text-midnight-400 hover:text-midnight-50" aria-label="Open menu">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <script>
        ...
        (function() {
            ...
            const overlay = document.getElementById('dashboard-menu-overlay');
