...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public-layout','data' => ['description' => 'Schedule HTTP jobs in the cloud with Cronjobs.to. Auto-retry on failure, Telegram & Email alerts, 2FA security, uptime monitoring, and status pages. Free plan available.','keywords' => 'cron job scheduler, http job scheduler, cloud cron, job monitoring, uptime monitoring, heartbeat monitoring, status page, scheduled tasks']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['description' => 'Schedule HTTP jobs in the cloud with Cronjobs.to. Auto-retry on failure, Telegram & Email alerts, 2FA security, uptime monitoring, and status pages. Free plan available.','keywords' => 'cron job scheduler, http job scheduler, cloud cron, job monitoring, uptime monitoring, heartbeat monitoring, status page, scheduled tasks']); ?>
    ...
    <section class="relative pt-24 pb-16 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-4xl mx-auto">
                <form id="job-creator-form" action="<?php echo e(route('guest.preview')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="url" name="url" id="url" required
                                       ...
                                       value="<?php echo e(old('url', session('pending_job.url', ''))); ?>">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <select name="http_method" id="http_method" class="select">
                                    <?php $__currentLoopData = ['GET', 'POST', 'PUT', 'PATCH', 'DELETE']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($method); ?>" <?php echo e(old('http_method', session('pending_job.http_method', 'GET')) === $method ? 'selected' : ''); ?>>
                                        <?php echo e($method); ?>
                            ...
                            <div>
                                ...
                                <select name="timezone" id="timezone" class="select">
                                    <?php $__currentLoopData = ['UTC', 'America/New_York', 'America/Los_Angeles', 'Europe/London', 'Europe/Paris', 'Europe/Istanbul', 'Asia/Tokyo', 'Asia/Shanghai', 'Australia/Sydney']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tz); ?>" <?php echo e(old('timezone', session('pending_job.timezone', 'UTC')) === $tz ? 'selected' : ''); ?>>
                                        <?php echo e($tz); ?>
                            ...
                            <div class="relative">
                                <div class="bg-midnight-950 rounded-lg border border-midnight-700 p-4">
                                    <div class="flex items-center justify-center gap-2 font-mono text-2xl">
                                        <input type="text" name="cron_minute" id="cron_minute" value="<?php echo e(old('cron_minute', '*')); ?>" 
                                        ...
                                        <input type="text" name="cron_hour" id="cron_hour" value="<?php echo e(old('cron_hour', '*')); ?>" 
                                               class="w-16 h-12 bg-midnight-800 border border-midnight-600 rounded-lg text-center text-midnight-100 text-xl focus:border-accent-500 focus:outline-none focus:ring-1 focus:ring-accent-500 transition-colors" 
                                               placeholder="*" oninput="updateCronExpression()">
                                        <input type="text" name="cron_day" id="cron_day" value="<?php echo e(old('cron_day', '*')); ?>" 
                                               class="w-16 h-12 bg-midnight-800 border border-midnight-600 rounded-lg text-center text-midnight-100 text-xl focus:border-accent-500 focus:outline-none focus:ring-1 focus:ring-accent-500 transition-colors" 
                                               placeholder="*" oninput="updateCronExpression()">
                                        <input type="text" name="cron_month" id="cron_month" value="<?php echo e(old('cron_month', '*')); ?>" 
                                               class="w-16 h-12 bg-midnight-800 border border-midnight-600 rounded-lg text-center text-midnight-100 text-xl focus:border-accent-500 focus:outline-none focus:ring-1 focus:ring-accent-500 transition-colors" 
                                               placeholder="*" oninput="updateCronExpression()">
                                        <input type="text" name="cron_weekday" id="cron_weekday" value="<?php echo e(old('cron_weekday', '*')); ?>" 
                                               class="w-16 h-12 bg-midnight-800 border border-midnight-600 rounded-lg text-center text-midnight-100 text-xl focus:border-accent-500 focus:outline-none focus:ring-1 focus:ring-accent-500 transition-colors" 
                                               placeholder="*" oninput="updateCronExpression()">
                                    </div>
                                    <!-- Field Labels -->
                                ...
                                <input type="hidden" name="cron_expression" id="cron_expression" value="<?php echo e(old('cron_expression', '* * * * *')); ?>">
                            </div>
            ...
            <div class="mt-12 pt-8 border-t border-midnight-800/50">
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 text-center">
                    ...
                    <a href="<?php echo e(route('pricing')); ?>" class="text-accent-400 hover:text-accent-300 text-sm font-medium flex items-center gap-1 transition-colors">
                        See pricing
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\CronjobsTOPRO\resources\views/landing.blade.php ENDPATH**/ ?>