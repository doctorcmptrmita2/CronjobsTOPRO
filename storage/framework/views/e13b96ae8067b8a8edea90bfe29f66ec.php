...
<!DOCTYPE html>
<html lang="<?php echo e(str_replace('_', '-', $currentLocale)); ?>" class="dark">
<head>
    <meta charset="utf-8">
    ...
    <meta name="robots" content="<?php echo e($noindex ? 'noindex, nofollow' : 'index, follow'); ?>">
    
    <!-- Canonical URL -->
    <link rel="canonical" href="<?php echo e($currentUrl); ?>">
    
    <!-- Hreflang Tags for Multi-Language Support -->
    <link rel="alternate" hreflang="en" href="<?php echo e($currentUrl); ?><?php echo e(str_contains($currentUrl, '?') ? '&' : '?'); ?>lang=en">
    <link rel="alternate" hreflang="tr" href="<?php echo e($currentUrl); ?><?php echo e(str_contains($currentUrl, '?') ? '&' : '?'); ?>lang=tr">
    <link rel="alternate" hreflang="de" href="<?php echo e($currentUrl); ?><?php echo e(str_contains($currentUrl, '?') ? '&' : '?'); ?>lang=de">
    ...
    <meta property="og:locale" content="<?php echo e($currentLocale); ?>">
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "<?php echo e($defaultDescription); ?>",
        "sameAs": [
    ...
    <script type="application/ld+json">
    {
        ...
        "potentialAction": {
            "@type": "SearchAction",
            "target": "<?php echo e($siteUrl); ?>/docs?search={search_term_string}",
...
<body class="bg-midnight-950 text-midnight-50 min-h-screen antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center gap-6" aria-label="Main navigation">
                    <a href="<?php echo e(route('docs')); ?>" class="text-sm text-midnight-400 hover:text-midnight-50 transition-colors">Docs</a>
                    <a href="<?php echo e(route('pricing')); ?>" class="text-sm text-midnight-400 hover:text-midnight-50 transition-colors">Pricing</a>
                    <a href="/#features" class="text-sm text-midnight-400 hover:text-midnight-50 transition-colors">Features</a>
                    <a href="<?php echo e(route('faq')); ?>" class="text-sm text-midnight-400 hover:text-midnight-50 transition-colors">FAQ</a>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="btn-secondary text-sm">Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-sm text-midnight-400 hover:text-midnight-50 transition-colors">Sign in</a>
    ...
    >
        ...
        <nav class="p-4 space-y-2" aria-label="Mobile navigation">
            ...
            <a href="<?php echo e(route('pricing')); ?>" class="flex items-center gap-3 px-4 py-3 text-midnight-300 hover:text-midnight-50 hover:bg-midnight-800 rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                Pricing
            </a>
            <a href="<?php echo e(route('docs')); ?>" class="flex items-center gap-3 px-4 py-3 text-midnight-300 hover:text-midnight-50 hover:bg-midnight-800 rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                Documentation
            </a>
            <a href="<?php echo e(route('faq')); ?>" class="flex items-center gap-3 px-4 py-3 text-midnight-300 hover:text-midnight-50 hover:bg-midnight-800 rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                FAQ
            </a>
            <a href="<?php echo e(route('about')); ?>" class="flex items-center gap-3 px-4 py-3 text-midnight-300 hover:text-midnight-50 hover:bg-midnight-800 rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                About Us
            </a>
            <a href="<?php echo e(route('contact')); ?>" class="flex items-center gap-3 px-4 py-3 text-midnight-300 hover:text-midnight-50 hover:bg-midnight-800 rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Auth Links -->
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-4 py-3 text-accent-400 hover:text-accent-300 hover:bg-accent-500/10 rounded-lg transition-colors">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="flex items-center gap-3 px-4 py-3 text-midnight-300 hover:text-midnight-50 hover:bg-midnight-800 rounded-lg transition-colors">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                    </svg>
                    Sign In
                </a>
                <a href="<?php echo e(route('register')); ?>" class="flex items-center justify-center gap-2 mt-4 px-4 py-3 bg-accent-500 text-midnight-950 font-semibold rounded-lg hover:bg-accent-400 transition-colors">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-midnight-800 bg-midnight-900">
            ...
            <p class="text-center text-xs text-midnight-600 mt-3">
                &copy; <?php echo e(date('Y')); ?> Cronjobs.to
            </p>
        </div>
    </aside>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
                ...
                <div class="col-span-2 lg:col-span-1">
                    ...
                    <!-- Status Badge -->
                    <a href="<?php echo e(route('system-status')); ?>" class="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/30 rounded-full text-xs text-emerald-400 hover:bg-emerald-500/20 transition-colors">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="<?php echo e(route('docs')); ?>" class="text-sm text-midnight-400 hover:text-accent-400 transition-colors">Documentation</a></li>
                        <li><a href="<?php echo e(route('faq')); ?>" class="text-sm text-midnight-400 hover:text-accent-400 transition-colors">FAQ</a></li>
                        <li><a href="<?php echo e(route('system-status')); ?>" class="text-sm text-midnight-400 hover:text-accent-400 transition-colors">System Status</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('about')); ?>" class="text-sm text-midnight-400 hover:text-accent-400 transition-colors">About Us</a></li>
                        <li><a href="<?php echo e(route('contact')); ?>" class="text-sm text-midnight-400 hover:text-accent-400 transition-colors">Contact</a></li>
                        <li><a href="<?php echo e(route('pricing')); ?>" class="text-sm text-midnight-400 hover:text-accent-400 transition-colors">Pricing</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="<?php echo e(route('privacy')); ?>" class="text-sm text-midnight-400 hover:text-accent-400 transition-colors">Privacy Policy</a></li>
                        <li><a href="<?php echo e(route('terms')); ?>" class="text-sm text-midnight-400 hover:text-accent-400 transition-colors">Terms of Service</a></li>
                        <li><a href="<?php echo e(route('contact')); ?>?type=abuse" class="text-sm text-midnight-400 hover:text-accent-400 transition-colors">Report Abuse</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="pt-8 border-t border-midnight-800 flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="text-sm text-midnight-500">
                    &copy; <?php echo e(date('Y')); ?> Cronjobs.to. All rights reserved.
                </p>
...
<?php /**PATH C:\wamp64\www\CronjobsTOPRO\resources\views/components/public-layout.blade.php ENDPATH**/ ?>