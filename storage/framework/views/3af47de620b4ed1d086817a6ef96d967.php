            ...
            <div class="flex items-start gap-3 flex-1 pr-8 sm:pr-0">
                ...
                <div class="min-w-0">
                    <p class="text-midnight-100 text-sm">
                        ...
                        <a href="<?php echo e(route('privacy')); ?>" class="text-accent-400 hover:text-accent-300 underline underline-offset-2">Learn more</a>
                    </p>
                </div>
            </div>
...
<?php /**PATH C:\wamp64\www\CronjobsTOPRO\resources\views/components/cookie-consent.blade.php ENDPATH**/ ?>