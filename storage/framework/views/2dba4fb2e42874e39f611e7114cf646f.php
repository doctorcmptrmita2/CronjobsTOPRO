...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public-layout','data' => ['title' => 'Privacy Policy - How We Protect Your Data','description' => 'Cronjobs.to Privacy Policy. Learn how we collect, use, and protect your data. GDPR compliant. We never sell your information. Last updated December 2025.','keywords' => 'privacy policy, data protection, GDPR, user privacy, data security, cookie policy, cronjobs.to privacy']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Privacy Policy - How We Protect Your Data','description' => 'Cronjobs.to Privacy Policy. Learn how we collect, use, and protect your data. GDPR compliant. We never sell your information. Last updated December 2025.','keywords' => 'privacy policy, data protection, GDPR, user privacy, data security, cookie policy, cronjobs.to privacy']); ?>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-12">
                ...
                <section>
                    ...
                    <p class="text-midnight-300">
                        Questions? Email <a href="mailto:privacy@cronjobs.to" class="text-accent-400 hover:underline">privacy@cronjobs.to</a> or use our <a href="<?php echo e(route('contact')); ?>" class="text-accent-400 hover:underline">contact form</a>.
                    </p>
                </section>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\CronjobsTOPRO\resources\views/pages/privacy.blade.php ENDPATH**/ ?>