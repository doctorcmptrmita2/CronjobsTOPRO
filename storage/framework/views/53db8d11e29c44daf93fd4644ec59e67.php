...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public-layout','data' => ['title' => 'Pricing','description' => 'Simple, transparent pricing for Cronjobs.to. Start free with 5 jobs, or upgrade to Pro for unlimited features. No hidden fees.','keywords' => 'cronjobs pricing, cron job scheduler cost, free cron service, job monitoring pricing, cloud scheduler plans']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Pricing','description' => 'Simple, transparent pricing for Cronjobs.to. Start free with 5 jobs, or upgrade to Pro for unlimited features. No hidden fees.','keywords' => 'cronjobs pricing, cron job scheduler cost, free cron service, job monitoring pricing, cloud scheduler plans']); ?>
    <section class="pt-32 pb-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div class="card p-8 <?php echo e($plan->slug === 'pro' ? 'border-accent-500/50 relative' : ''); ?>">
                    ...
                    <div class="text-center mb-8">
                        <h2 class="text-lg font-semibold text-midnight-300 uppercase tracking-wider mb-2"><?php echo e($plan->name); ?></h2>
                        <div class="flex items-baseline justify-center gap-1">
                            <span class="text-4xl font-bold text-midnight-50">
                                <?php echo e($plan->slug === 'free' ? 'Free' : '$5'); ?>
                    ...
                    <ul class="space-y-4 mb-8">
                        <li class="flex items-center gap-3 text-midnight-300">
                            ...
                            <span><strong class="text-midnight-100"><?php echo e($plan->max_jobs); ?></strong> scheduled jobs</span>
                        </li>
                        <li class="flex items-center gap-3 text-midnight-300">
                            <svg class="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span><strong class="text-midnight-100"><?php echo e($plan->min_interval_minutes); ?> min</strong> minimum interval</span>
                        </li>
                        <li class="flex items-center gap-3 text-midnight-300">
                            <svg class="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span><strong class="text-midnight-100"><?php echo e($plan->log_retention_days); ?> days</strong> log retention</span>
                        </li>
                        <li class="flex items-center gap-3 text-midnight-300">
                            <svg class="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="<?php echo e($plan->slug === 'pro' ? 'btn-primary' : 'btn-secondary'); ?> w-full justify-center">
                        <?php echo e(auth()->user()->plan_id === $plan->id ? 'Current Plan' : 'Get Started'); ?>

                    </a>
                    <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="<?php echo e($plan->slug === 'pro' ? 'btn-primary' : 'btn-secondary'); ?> w-full justify-center">
                        Get Started
                    </a>
                    <?php endif; ?>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\CronjobsTOPRO\resources\views/pricing.blade.php ENDPATH**/ ?>